...
Generated 2026-09-01 03:31 UTC by `ops/db/report.py` from the live database — do not hand-edit; re-run the script instead.
...
- TASK-022 — Milestone D: Project / Phase Progress (IN_DEVELOPMENT, owner: developer, progress: not broken into steps)
