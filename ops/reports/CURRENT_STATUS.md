...
Generated 2026-09-01 03:14 UTC by `ops/db/report.py` from the live database — do not hand-edit; re-run the script instead.
...
- TASK-022 — Milestone D: Project / Phase Progress (MOCKUP_REVIEW, owner: design, progress: not broken into steps)
