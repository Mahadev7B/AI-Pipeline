...
Generated 2026-09-01 19:38 UTC by `ops/db/report.py` from the live database — do not hand-edit; re-run the script instead.
...
- TASK-024 — Founder Idea Intake: submit a new idea from the Control Center UI (PLANNING, owner: —, progress: not broken into steps)
