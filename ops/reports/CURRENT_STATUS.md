...
Generated 2026-09-01 02:35 UTC by `ops/db/report.py` from the live database — do not hand-edit; re-run the script instead.
...
- TASK-021 — Milestone C: Company-wide Risks register (MOCKUP_REVIEW, owner: design, progress: not broken into steps)
