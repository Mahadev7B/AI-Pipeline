...
Generated 2026-09-01 02:43 UTC by `ops/db/report.py` from the live database — do not hand-edit; re-run the script instead.
...
- TASK-021 — Milestone C: Company-wide Risks register (RED_TEAM_REVIEW, owner: red-team, progress: not broken into steps)
