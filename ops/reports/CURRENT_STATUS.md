...
Generated 2026-08-31 22:49 UTC by `ops/db/report.py` from the live database — do not hand-edit; re-run the script instead.
...
- TASK-019 — Milestone A: Active Work dashboard + Task Detail page (ARCHITECTURE, owner: cto, progress: not broken into steps)
