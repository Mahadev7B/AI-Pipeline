...
Generated 2026-09-01 01:51 UTC by `ops/db/report.py` from the live database — do not hand-edit; re-run the script instead.
...
- TASK-017 — Risk id=3 reduction milestone: reviewer zero-tool rollout + self-immune Developer denylist (CODE_REVIEW, owner: code-review, progress: not broken into steps)
...
- TASK-020 — Milestone B: Company-wide AI cost visibility (CODE_REVIEW, owner: developer, progress: not broken into steps)
