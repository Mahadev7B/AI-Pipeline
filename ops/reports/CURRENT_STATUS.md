...
Generated 2026-09-01 03:43 UTC by `ops/db/report.py` from the live database — do not hand-edit; re-run the script instead.
...
- TASK-022 — Milestone D: Project / Phase Progress (CODE_REVIEW, owner: developer, progress: not broken into steps)
