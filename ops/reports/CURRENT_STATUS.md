...
Generated 2026-09-01 16:12 UTC by `ops/db/report.py` from the live database — do not hand-edit; re-run the script instead.
...
## In progress
- TASK-023 — risks.id=3 durable closure: OS-level/process-separation sandboxing for Developer (RED_TEAM_REVIEW, owner: —, progress: not broken into steps)
