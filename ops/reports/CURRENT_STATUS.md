...
Generated 2026-09-01 19:48 UTC by `ops/db/report.py` from the live database — do not hand-edit; re-run the script instead.
...
- TASK-024 — Founder Idea Intake: submit a new idea from the Control Center UI (MOCKUP, owner: —, progress: not broken into steps)
