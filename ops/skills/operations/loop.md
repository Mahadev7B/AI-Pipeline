...
When to invoke: Phase 3 — Orchestrator running a recurring status/orchestration check; DevOps polling a recurring deploy/CI check.
...
Which agents may use it: Orchestrator Agent (Phase 3), Release/DevOps Agent.
