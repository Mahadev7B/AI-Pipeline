...
When to invoke: Chief of Staff adding, updating, or evaluating an entry in the Skill Registry as the real installed-skills set changes.
...
Which agents may use it: Chief of Staff.
